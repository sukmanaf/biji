...
export async function GET(request: Request, { params }: { params: { id: string } }) {
  try {
    ...
    const Record = await prisma.foto_berseri.findUnique({
       where: { id },
       include:{
        siswa : {
          include:{
      ...
      const record = {
        a_agama : Record.a_agama,
        a_jati_diri : Record.a_jati_diri,
        a_literasi : Record.a_literasi,
        minggu_ke : Record.minggu_ke,
        semester : Record.semester,
        siswa : Record.siswa.nama,
        guru : Record.siswa.guru,
        tahun_ajaran : Record.siswa.ta.tahun_ajaran,
        kelompok : Record.siswa.kelompok,
        path_foto1 : Record.foto_berseri_file[0].file_path,
        keterangan1 : Record.foto_berseri_file[0].keterangan,
        path_foto2 : Record.foto_berseri_file[1].file_path,
        keterangan2 : Record.foto_berseri_file[1].keterangan,
        path_foto3 : Record.foto_berseri_file[2].file_path,
        keterangan3 : Record.foto_berseri_file[2].keterangan,
      }
